    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          ...
          <p>Since our inception, we've worked tirelessly to curate a diverse selection of high-quality products that cater to every faste and preference.
      ...
      <div className='flex flex-col md:flex-row text-sm md-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenince:</b>
          <p className='text-gray-600'> with our user-frindly interface and hassle-free ordering process,shopping has never been easir.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Exceptional Customer Service:</b>
          <p className='text-gray-600'>Our team of dedicated professionals is here to assist you the way, ensuring your satisfaction is our top priortiy.</p>
        </div>
      </div>
